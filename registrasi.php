            ...
            <div class="box">
               ...
               <?php
                   if(isset($_POST['submit'])){
                    ...
                    $foto_profil_temp = $_FILES['foto_profil']['tmp_name'];
                    $upload_directory = "profilpic/"; // Sesuaikan dengan direktori penyimpanan Anda
                    move_uploaded_file($foto_profil_temp, $upload_directory . $foto_profil);
                    ...
                    $insert = mysqli_query($conn, "INSERT INTO tb_admin (admin_name, username, password, admin_telp, admin_email, admin_address, foto_profil) VALUES (
                                        '$nama',
                                        '$username',
                                        '$password',
                                        '$telpon',
                                        '$mail',
                                        '$alamat',
                                        '$upload_directory$foto_profil')"); // Simpan path foto profil di database
                    if($insert){
