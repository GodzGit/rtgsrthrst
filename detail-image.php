...
<style>
    ...
    box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2); /* Efek bayangan tombol */
}
    ...
    <div class="container">
        ...
        <div class="box">
            ...
            <div class="col-2">
                ...
                <?php else: ?>
                <p>Anda harus <button class="btn"><a href="login.php">Login</a></button> untuk memberikan like atau komentar.</p>
                <?php endif; ?>
        ...
        <button type="button" class="button-download">Download Gambar</button>
                ...
                if (mysqli_num_rows($komentarQuery) > 0) {
                    ...
                    while ($komentar = mysqli_fetch_assoc($komentarQuery)) {
                        // Mengambil nama admin dari tabel admin berdasarkan ID admin yang terkait dengan komentar
                        $adminId = $komentar['admin_id'];
                        $adminQuery = mysqli_query($conn, "SELECT admin_name FROM tb_admin WHERE admin_id = '$adminId'");
                        $adminData = mysqli_fetch_assoc($adminQuery);
                        
                        // Menampilkan komentar dengan nama admin yang sesuai
                        echo "<p><strong>" . $adminData['admin_name'] . "</strong>: " . $komentar['isikomentar'] . "</p>";
                    }
                } else {
